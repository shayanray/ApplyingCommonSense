...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        if args.model == "cnn_ngrams":
            ...
            total_steps_train = 15000 # increase to 50000 later
            ...
            model = cnn_lstm_sent.Cnn_lstm_sentiment(train_generator = gen_train, validation_generator = gen_val, conceptnet = False) ## set it to True/False for activate/deactivate commonsense
