...
conceptnet_numbatch_path = 'conceptnet_embeddings/numberbatch-en.txt'
...
test_set_cloze = data_folder + '/test-small.csv' # '/cloze_test_spring2016-test.csv'
...
test_pos_begin = data_folder + '/test_set_pos_begin.npy' #'/test-small_pos_begin.npy' 
test_pos_end = data_folder + '/test_set_pos_end.npy' #'/test-small_pos_end.npy' 

#PREDICTION (2343 samples)
test_cloze_pos_begin = data_folder + '/test_nlu18_utf-8_pos_begin.npy' #'/test-small_pos_begin.npy' 
test_cloze_pos_end = data_folder + '/test_nlu18_utf-8_pos_end.npy' #'/test-small_pos_end.npy' 
