...
class Cnn_bilstm_attn_sentiment():
    ...
    def __init__(self, train_generator, validation_generator = [], path=None,
        ...
        """Embedding layer"""
        if conceptnet:
          ### with concept-net START
          print ("Loading ConceptNET numberbatch now ............. ")
          _,cnetnb = data_utils.load_cnet_numbatch()    
          self.embedding_dimensions_words = cnetnb.shape[1] # *** conceptnet numberbatch ****
          vocabulary_size = cnetnb.shape[0] ## conceptnet 
          self.model.add(Embedding(input_dim = vocabulary_size, output_dim = self.embedding_dimensions_words, input_length = story_len, weights=[cnetnb], trainable=False))
          ### with concept-net END
        else:
          ### without concept-net START
          print ("No common sense applied !! .............. ")
        ...
        self.model.add(LSTM(128, activation='tanh', recurrent_activation='hard_sigmoid', use_bias=True, kernel_initializer='glorot_uniform', recurrent_initializer='orthogonal', bias_initializer='zeros', unit_forget_bias=True, kernel_regularizer=None, recurrent_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, recurrent_constraint=None, bias_constraint=None, dropout=0.0, recurrent_dropout=0.0, implementation=1, return_sequences=True,  return_state=False, go_backwards=False, stateful=False, unroll=False))

        self.model.add(attention_3d_block(lstm_out))
